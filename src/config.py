...
WHISPER_LANGUAGE = "ru"
MIC_DEVICE_INDEX = "pipewire"  # pipewire = работает с BT mic (AirPods, USB), через PipeWire напрямую
...
# --- Motors ---
MOTOR_SERIAL_PORT = os.getenv("MOTOR_PORT", "/dev/ttyUSB1")
MOTOR_BAUDRATE = 38400
MOTOR_DEAD_ZONE = 10
MOTOR_CONTROL_HZ = 10

# --- Lidar ---
LIDAR_PORT = os.getenv("LIDAR_PORT", "/dev/ttyUSB0")   # YDLIDAR X4-Pro
